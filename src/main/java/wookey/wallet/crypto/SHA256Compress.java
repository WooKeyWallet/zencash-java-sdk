...
public class SHA256Compress
     ...
     * message digest.
     */
    public SHA256Compress(SHA256Compress t) {
        super(t);

        copyIn(t);
    }

    private void copyIn(SHA256Compress t) {
        super.copyIn(t);
    ...
    public SHA256Compress(byte[] encodedState) {
        super(encodedState);
...
//        X[xOff] = Pack.bigEndianToInt(in, inOff);
    ...
    public Memoable copy() {
        return new SHA256Compress(this);
    }

    @Override
    public void reset(Memoable other) {
        SHA256Compress d = (SHA256Compress) other;
    ...
    public byte[] getEncodedState() {
        ...
        Pack.intToBigEndian(H1, state, 0);
        Pack.intToBigEndian(H2, state, 4);
        Pack.intToBigEndian(H3, state, 8);
        Pack.intToBigEndian(H4, state, 12);
        Pack.intToBigEndian(H5, state, 16);
        Pack.intToBigEndian(H6, state, 20);
        Pack.intToBigEndian(H7, state, 24);
        Pack.intToBigEndian(H8, state, 28);
        return state;
    }
}
